parcelRequire = (function(e) {
	...
	(c.deparam = h), (c.param = d);
	var e = h(location.search.substr(1)),
		i = e.utterances;
	if (i) {
		delete e.utterances;
		var f = d(e);
		f.length && (f = '?' + f),
			history.replaceState(
				void 0,
				document.title,
				location.pathname + f + location.hash
			);
	}
	...
	for (var a = {}, g = 0; g < b.attributes.length; g++) {
		var j = b.attributes.item(g);
	...
	b.insertAdjacentHTML(
		'afterend',
		'<div class="utterances">\n    <iframe class="utterances-frame" title="Comments" scrolling="no" src="' +
			o +
			'?' +
			d(a) +
			'"></iframe>\n  </div>'
